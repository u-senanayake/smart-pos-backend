...
INSERT INTO Users (username, first_name, last_name, email, address, phone_no_1, phone_no_2,
                   role_id, password, enabled, locked, created_at, updated_at,
                   created_user_id, updated_user_id, deleted, deleted_at, deleted_user_id)
VALUES ('john_doe', 'John', 'Doe', 'john.doe@example.com', '456 Elm St, City, Country', '1112223333', '3332221111', 2,
        '$2a$10$abcdefghijklmnopqrstuv', TRUE, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 1, FALSE, NULL, NULL);
INSERT INTO Users (username, first_name, last_name, email, address, phone_no_1, phone_no_2,
                   role_id, password, enabled, locked, created_at, updated_at,
                   created_user_id, updated_user_id, deleted, deleted_at, deleted_user_id)
VALUES ('jane_smith', 'Jane', 'Smith', 'jane.smith@example.com', '789 Oak St, City, Country', '4445556666',
        '6665554444', 3, '$2a$10$abcdefghijklmnopqrstuv', TRUE, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 1,
        FALSE, NULL, NULL);
INSERT INTO Users (username, first_name, last_name, email, address, phone_no_1, phone_no_2,
                   role_id, password, enabled, locked, created_at, updated_at,
                   created_user_id, updated_user_id, deleted, deleted_at, deleted_user_id)
VALUES ('peter_parker', 'Peter', 'Parker', 'peter.parker@example.com', '101 Maple St, City, Country', '7778889999',
        '9998887777', 2, '$2a$10$abcdefghijklmnopqrstuv', TRUE, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 1,
        FALSE, NULL, NULL);
INSERT INTO Users (username, first_name, last_name, email, address, phone_no_1, phone_no_2,
                   role_id, password, enabled, locked, created_at, updated_at,
                   created_user_id, updated_user_id, deleted, deleted_at, deleted_user_id)
VALUES ('bruce_wayne', 'Bruce', 'Wayne', 'bruce.wayne@example.com', '500 Gotham Ave, Gotham City', '2223334444',
        '4443332222', 1, '$2a$10$abcdefghijklmnopqrstuv', TRUE, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 1,
        FALSE, NULL, NULL);
INSERT INTO Users (username, first_name, last_name, email, address, phone_no_1, phone_no_2,
                   role_id, password, enabled, locked, created_at, updated_at,
                   created_user_id, updated_user_id, deleted, deleted_at, deleted_user_id)
VALUES ('clark_kent', 'Clark', 'Kent', 'clark.kent@example.com', '600 Metropolis St, Metropolis', '5556667777',
        '7776665555', 3, '$2a$10$abcdefghijklmnopqrstuv', TRUE, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 1,
        FALSE, NULL, NULL);
INSERT INTO Users (username, first_name, last_name, email, address, phone_no_1, phone_no_2,
                   role_id, password, enabled, locked, created_at, updated_at,
                   created_user_id, updated_user_id, deleted, deleted_at, deleted_user_id)
