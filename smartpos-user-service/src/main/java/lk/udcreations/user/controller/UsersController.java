...
public class UsersController {
    ...
    @Operation(
            ...
            description = "Retrieve all users, including deleted users.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Successfully retrieved list",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsersDTO.class, type = "array"))),
            @ApiResponse(
                    responseCode = "500",
    ...
    @Operation(
            ...
            description = "Retrieve all non-deleted users.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Mark a user as deleted instead of removing permanently.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
    ...
    public ResponseEntity<Void> deleteUser(
            @Parameter(description = "ID of the user to soft delete", required = true, example = "1")
            @PathVariable Integer userId,
            @Parameter(hidden = true) @AuthenticationPrincipal String loggedInUsername) {
