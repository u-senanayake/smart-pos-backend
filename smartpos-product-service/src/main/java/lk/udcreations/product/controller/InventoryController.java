...
public class InventoryController {
	...
	@Operation(
			summary = "Add stock",
			description = "Add stock to a product by product ID.")
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Decrease stock for a product by product ID.")
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Fetch the current stock level of a product.")
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
					description = "Stock level fetched successfully"),
			@ApiResponse(
					responseCode = "404",
					description = "Product not found", content = @Content)})
	...
	@Operation(
			...
			description = "Retrieve detailed stock information for a product.")
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Update stock alert and warning levels for a product.")
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			summary = "Check stock alerts",
			description = "Retrieve products below stock alert levels.")
	@ApiResponse(
			responseCode = "200",
			description = "Successfully retrieved stock alerts")
	@GetMapping("/alerts")
	...
	@Operation(
			summary = "Check stock warnings",
			description = "Retrieve products below stock warning levels.")
	@ApiResponse(
			responseCode = "200",
			description = "Successfully retrieved stock warnings")
	@GetMapping("/warnings")
