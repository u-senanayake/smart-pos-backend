...
public class CategoryController {
    ...
    public CategoryDTO createCategory(
            @Parameter(description = "Category object to be created") @Valid @RequestBody Category category, @AuthenticationPrincipal String loggedInUsername) {
        return categoryService.createCategory(category, loggedInUsername);
    }
    ...
    public ResponseEntity<CategoryDTO> updateCategory(
            ...
            @Parameter(description = "Updated category details") @Valid @RequestBody Category updatedCategory, @AuthenticationPrincipal String loggedInUsername) {
        return ResponseEntity.ok(categoryService.updateCategory(categoryId, updatedCategory, loggedInUsername));
    }
    ...
    public ResponseEntity<Void> deleteCategory(
            @Parameter(description = "ID of the category to delete") @PathVariable Integer categoryId, @AuthenticationPrincipal String loggedInUsername) {
        categoryService.softDeleteCategory(categoryId, loggedInUsername);
