...
class ProductServiceTest {
    ...
    void setUp() {
        ...
        mockImage.setImageType("product");
        List<ImageDTO> mockImageList = List.of(mockImage);
        ...
        when(fileServiceClient.getImageDataByImageTypeAndTypeId("product", 1)).thenReturn(mockImageList);
        ...
        when(modelMapper.map(any(), any())).thenAnswer(invocation -> {
            ...
            if (source instanceof Product product && targetClass == ProductDTO.class) {
                return getProductDTO(product);
            } else if (source instanceof Category category && targetClass == CategoryDTO.class) {
                CategoryDTO dto = new CategoryDTO();
                dto.setCategoryId(category.getCategoryId());
                dto.setName(category.getName());
                return dto;
            } else if (source instanceof Distributor distributor && targetClass == DistributorDTO.class) {
                ...
                return dto;
            } else if (source instanceof Inventory inventory && targetClass == InventoryDTO.class) {
  ...
  /*  @Test
    void testCreateProduct_NewProduct() {
        ...
        ProductDTO result = productService.createProduct(createProductDTO., any(MultipartFile.class), "admin");
    ...
    void testUpdateProduct_ProductExists() {
        ...
        ProductDTO result = productService.updateProduct(1, updateProductDTO, "admin");
    ...
    void testUpdateProduct_ProductNotFound() {
        ...
        Exception exception = assertThrows(RuntimeException.class,
                () -> productService.updateProduct(999, updateProductDTO, "admin"));
    ...
    void testSoftDeleteProduct_ProductExists() {
        ...
        productService.softDeleteProduct(1, adminUsername);
    ...
    void testSoftDeleteProduct_ProductNotFound() {
        ...
        Exception exception = assertThrows(NotFoundException.class, () -> productService.softDeleteProduct(999, adminUsername));
