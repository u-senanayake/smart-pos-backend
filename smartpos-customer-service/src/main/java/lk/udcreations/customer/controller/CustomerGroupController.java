...
public class CustomerGroupController {
    ...
    @Operation(
            ...
            description = "Retrieve all customer groups, including soft-deleted ones.")
    @ApiResponse(
            responseCode = "200",
            description = "Successfully retrieved customer groups")
    @GetMapping("/all")
    ...
    @Operation(
            ...
            description = "Retrieve all non-deleted customer groups.")
    @ApiResponse(
            responseCode = "200",
            description = "Successfully retrieved active customer groups")
    @GetMapping
    ...
    @Operation(
            ...
            description = "Retrieve customer group details by its ID.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Customer group found",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = CustomerGroupDTO.class))),
            @ApiResponse(
                    responseCode = "404",
                    description = "Customer group not found", content = @Content)})
    ...
    @Operation(
            ...
            description = "Update customer group details by its ID.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
     ...
     */
    @Operation(
            summary = "Soft delete a customer group",
            description = "Soft delete a customer group by marking it as deleted.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
                    description = "Customer group soft-deleted successfully"),
            @ApiResponse(
                    responseCode = "404",
                    description = "Customer group not found",
                    content = @Content)})
